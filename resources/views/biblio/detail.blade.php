                    ...
                    <div class="body">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    @foreach ($emplacement->biblios as $biblio)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="icon-button-demo">
                                                ...
                                                @if ( Auth::user()->is_admin)
                                                    ...
                                                    <div class="modal fade" id="supp{{$biblio->id }}Modal" tabindex="-1" role="dialog" aria-labelledby="supp{{ $biblio->id }}ModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form class="form-inline" action="{{ url('Bibliotheque/'.$biblio->id)}}"  method="POST">
                                                                        @method('DELETE')
                                                                        @csrf
