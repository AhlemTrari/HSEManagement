...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 clearfix demo-button-sizes" style="float: right">
                        @if ( Auth::user()->is_admin)
                            <button type="button" class="btn bg-teal btn-block btn-lg waves-effect" data-toggle="modal" data-target="#nv">Nouvelle carte</button>
                        @endif
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="nv" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form action="{{url('/Cartes')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="row clearfix" style="margin-top: 30px">
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" title="nouvel emplacement" data-toggle="modal" data-target="#nvEmplacement" class="add-row btn bg-light-green btn-circle waves-effect waves-circle waves-float">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        <label style="margin-top: 10px">Date de carte</label>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-line">
    ...
    <div class="modal fade" id="nvEmplacement" tabindex="-1" role="dialog" style="padding-top: 50px">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="largeModalLabel">Nouvel emplacement</h4>
                </div>
                <form id="addEmplacement">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="row clearfix" style="margin-top: 30px">
                            <div class="form-group">
