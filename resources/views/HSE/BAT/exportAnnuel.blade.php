    ...
    <body>
        <table>
            <tr>
                ...
                <td style="width: 80%">
                   <h2> BILAN ANNUEL DES ACCIDENTS DE TRAVAIL ANNEE " {{$bilan->annee}} " </h2>
                </td>
            </tr>
        </table><br>
         ...
         <table>
            ...
            <tbody>
                <tr>
                    ...
                    @foreach ($bilan->bilanMensuel as $bilanMensuel)
                        <td> {{$bilanMensuel->nbr_accidents}}</td>
                    @endforeach
                </tr>
                <tr>
                    <td><strong>Nbr de journées perdues</strong></td>
                    @foreach ($bilan->bilanMensuel as $bilanMensuel)
                        <td> {{$bilanMensuel->nbr_jours}}</td>
                    @endforeach
                </tr>
            </tbody>
        </table>
