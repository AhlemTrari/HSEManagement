                ...
                <div class="row">
                    ...
                    <div class="col-md-4 clearfix demo-button-sizes" style="float: right">
                        ...
                        <ul class="dropdown-menu">
                            @if ($bilanT && $bilanH)
                            <li><a href="{{url('/exportConsolideSemestriel/'.$t.'/'.$annee)}}" target="_blank" class=" waves-effect waves-block">bilan consolidé</a></li>
                            @endif
                            @if ($bilanT)
                            <li><a href="{{url('/exportBilanSemestriel/'.$bilanT->id)}}" target="_blank" class=" waves-effect waves-block">Bilan unité Terga</a></li>
                            @endif
                            @if ($bilanH)
                            <li><a href="{{url('/exportBilanSemestriel/'.$bilanH->id)}}" target="_blank" class=" waves-effect waves-block">Bilan unité Hennaya</a></li>
                            @endif
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="card">
                                            <div class="header">
                                                <h2>
                                                    BILAN CONSOLIDE DES ACCIDENTS DE TRAVAIL DU SEMESTRE " {{$t}} {{$annee}} " 
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="header">
                                                <h2>
                                                    ...
                                                    BILAN DES ACCIDENTS DE TRAVAIL UNITE TERGA DU SEMESTRE " {{$bilanT->semestre}} {{$bilanT->annee}} " 
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="header">
                                            <h2>
                                                ...
                                                BILAN DES ACCIDENTS DE TRAVAIL UNITE TERGA DU SEMESTRE " {{$bilanH->semestre}} {{$bilanH->annee}} " 
                                            </h2>
                                        </div>
                                    </div>
                                </div>
