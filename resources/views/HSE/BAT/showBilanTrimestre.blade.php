...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                ...
                <div class="row clearfix demo-button-sizes">
                    ...
                    <div class="col-md-4 clearfix demo-button-sizes" style="float: right">
                        <a href="{{url('/exportBilanTrimestriel/'.$bilan->id)}}" type="button" target="_blank" class="btn bg-teal btn-block btn-lg waves-effect">
                            Exporter en pdf 
                        </a>
                    </div>
                </div>
            ...
            <div class="block-header">
                <h2>
                    BILAN DES ACCIDENTS DE TRAVAIL DU "TRIMESTRE {{$bilan->trimestre}}"
                </h2>
            </div>
            <div class="row">
