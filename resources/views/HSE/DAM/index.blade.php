                ...
                <div class="row">
                    ...
                    <div class="col-md-4 clearfix demo-button-sizes" style="float: right">
                        @if (! Auth::user()->is_admin)
                            <a type="button" href="{{url('/DeclarationAccidentM/create')}}" class="btn bg-teal btn-block btn-lg waves-effect">Nouvelle déclaration</a>
                        @endif
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                               Déclarations d'accidents de matériel :
                            </h2>
                        </div>
                        <div class="body">
