            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                               Déclarations des accidents matériel par mois:
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Déclarations des accidents matériel {{$declaration->year}}</td>
                                            @if (Auth::user()->is_admin)
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Déclarations des accidents matériel par trimestre:
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        @foreach ($declarationsT as $declaration)
                                        <tr>
                                            <td>Déclarations des accidents matériel {{$declaration->year}} {{$declaration->trimestre}}</td>
                                            @if (Auth::user()->is_admin)
                                                @if ($declaration->unite == 1)
                                                    <td>Unité Terga</td>
                                                @else
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Déclarations des accidents matériel par semestre:
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        @foreach ($declarationsS as $declaration)
                                        <tr>
                                            <td>Déclarations des accidents matériel {{$declaration->year}} {{$declaration->semestre}}</td>
                                            @if (Auth::user()->is_admin)
                                                @if ($declaration->unite == 1)
                                                    <td>Unité Terga</td>
                                                @else
